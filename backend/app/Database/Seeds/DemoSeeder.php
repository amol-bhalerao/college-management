    ...
    public function run(): void
    {
        ...
        if ($db->tableExists('website_pages')) {
            ...
            foreach ([
                ...
                8 => ['nav_label' => 'IQAC', 'menu_group' => 'IQAC', 'show_on_home' => 1, 'sort_order' => 7],
                9 => ['nav_label' => 'Library', 'menu_group' => 'Library', 'show_on_home' => 0, 'sort_order' => 8],

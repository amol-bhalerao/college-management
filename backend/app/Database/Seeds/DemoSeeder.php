    ...
    public function run(): void
    {
        ...
        if ($db->tableExists('website_pages')) {
            $db->table('website_pages')->ignore(true)->insertBatch([
                ['id' => 1, 'institute_id' => 1, 'slug' => 'home', 'nav_label' => 'Home', 'menu_group' => 'Home', 'title' => 'Junior College Home', 'hero_title' => 'Admissions Open for 2025-26', 'hero_subtitle' => 'Scholarship-friendly, institute-aware college management with modern student services.', 'body_html' => '<section><h2>About the College</h2><p>Junior College supports admissions, scholarships, certificates, student mentoring, and transparent academic communication.</p></section><section><h2>Key Highlights</h2><ul><li>Scholarship help desk</li><li>Verified fee receipts</li><li>IQAC-ready documentation</li></ul></section>', 'seo_title' => 'Junior College Admissions, Scholarship and Student Support', 'seo_description' => 'Explore admissions, scholarships, receipts, and student support services for Junior College.', 'is_published' => 1, 'sort_order' => 1, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 2, 'institute_id' => 1, 'slug' => 'about', 'nav_label' => 'About Us', 'menu_group' => 'About', 'title' => 'About Our Junior College', 'hero_title' => 'About Our Junior College', 'hero_subtitle' => 'NAAC-ready teaching, guidance, and transparent student support processes.', 'body_html' => '<section><h2>Institution Profile</h2><p>The institute focuses on quality education, scholarship support, and digital academic administration for students and parents.</p></section><section><h2>Vision</h2><p>To provide equitable, student-focused, and quality-oriented higher secondary education.</p></section>', 'seo_title' => 'About Junior College and Academic Services', 'seo_description' => 'Learn about the institute profile, academic support, and student development services.', 'is_published' => 1, 'sort_order' => 2, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 3, 'institute_id' => 2, 'slug' => 'home', 'nav_label' => 'Home', 'menu_group' => 'Home', 'title' => 'Degree College Home', 'hero_title' => 'Career-focused undergraduate programs', 'hero_subtitle' => 'Career-focused undergraduate programs with transparent student services.', 'body_html' => '<section><h2>Programs</h2><p>B.A., B.Com., and BCA public information, student services, and admission guidance are managed in one place.</p></section>', 'seo_title' => 'Degree College Programs and Admission Support', 'seo_description' => 'Degree College public information page with programs, student services, and admission updates.', 'is_published' => 1, 'sort_order' => 1, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 4, 'institute_id' => 1, 'slug' => 'admissions', 'nav_label' => 'Admissions', 'menu_group' => 'Admissions', 'title' => 'Admissions and Eligibility', 'hero_title' => 'Admission support for FYJC and scholarship-oriented applicants.', 'hero_subtitle' => 'Admission support for FYJC and scholarship-oriented applicants.', 'body_html' => '<section><h2>Admission Process</h2><ol><li>Enquiry registration</li><li>Document verification</li><li>Merit and allotment</li><li>Fee confirmation</li></ol></section>', 'seo_title' => 'Admissions and Eligibility Details', 'seo_description' => 'Admission process, eligibility, document checklist, and counselling guidance for new students.', 'is_published' => 1, 'sort_order' => 3, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 5, 'institute_id' => 1, 'slug' => 'academics', 'nav_label' => 'Academics', 'menu_group' => 'Academics', 'title' => 'Academic Programs and Student Support', 'hero_title' => 'Curriculum support, mentoring, and examination readiness.', 'hero_subtitle' => 'Curriculum support, mentoring, and examination readiness.', 'body_html' => '<section><h2>Academic Support</h2><ul><li>Bridge courses</li><li>Mentoring</li><li>Result analysis</li><li>Career guidance</li></ul></section>', 'seo_title' => 'Academic Programs and Student Support', 'seo_description' => 'Explore curriculum support, mentoring, and examination services for students.', 'is_published' => 1, 'sort_order' => 4, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 6, 'institute_id' => 1, 'slug' => 'facilities', 'nav_label' => 'Facilities', 'menu_group' => 'Facilities', 'title' => 'Campus Facilities', 'hero_title' => 'Library, ICT support, counselling, and student service windows.', 'hero_subtitle' => 'Library, ICT support, counselling, and student service windows.', 'body_html' => '<section><h2>Facilities</h2><ul><li>Library and reading room</li><li>ICT-enabled classroom support</li><li>Scholarship help desk</li><li>Student grievance support</li></ul></section>', 'seo_title' => 'Campus Facilities and Student Services', 'seo_description' => 'College facilities including library, ICT resources, and student support services.', 'is_published' => 1, 'sort_order' => 5, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 7, 'institute_id' => 1, 'slug' => 'iqac', 'nav_label' => 'IQAC', 'menu_group' => 'IQAC', 'title' => 'IQAC and Quality Assurance', 'hero_title' => 'Quality initiatives, NAAC readiness, and documentation support.', 'hero_subtitle' => 'Quality initiatives, NAAC readiness, and documentation support.', 'body_html' => '<section><h2>IQAC Initiatives</h2><p>Academic planning, feedback, documentation, and evidence management are coordinated through the quality cell.</p></section>', 'seo_title' => 'IQAC and NAAC Quality Initiatives', 'seo_description' => 'Public overview of quality assurance, IQAC initiatives, and NAAC-aligned work.', 'is_published' => 1, 'sort_order' => 6, 'created_at' => $now, 'updated_at' => $now],
                ['id' => 8, 'institute_id' => 1, 'slug' => 'contact', 'nav_label' => 'Contact', 'menu_group' => 'Contact', 'title' => 'Contact and Help Desk', 'hero_title' => 'Reach the admission desk, office, and student support team.', 'hero_subtitle' => 'Reach the admission desk, office, and student support team.', 'body_html' => '<section><h2>Office Contact</h2><p>Visitors may contact the office for admissions, certificates, fees, and scholarship support during working hours.</p></section>', 'seo_title' => 'Contact Office and Help Desk', 'seo_description' => 'Contact details for admission desk, office staff, and student help support.', 'is_published' => 1, 'sort_order' => 7, 'created_at' => $now, 'updated_at' => $now],
            ]);

            $db->table('website_pages')->where('id', 1)->update([
                'nav_label' => 'Home',
                'menu_group' => 'Home',
                'sort_order' => 1,
                'updated_at' => $now,
            ]);
            $db->table('website_pages')->where('id', 2)->update([
                'nav_label' => 'About Us',
                'menu_group' => 'About',
                'sort_order' => 2,
                'updated_at' => $now,
            ]);
            $db->table('website_pages')->where('id', 3)->update([
                'nav_label' => 'Home',
                'menu_group' => 'Home',
                'sort_order' => 1,
                'updated_at' => $now,

...
INSERT IGNORE INTO `website_pages` (`id`, `institute_id`, `slug`, `nav_label`, `menu_group`, `title`, `hero_title`, `hero_subtitle`, `body_html`, `seo_title`, `seo_description`, `is_published`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 1, 'home', 'Home', 'Home', 'Junior College Home', 'Admissions Open for 2025-26', 'Scholarship-friendly, institute-aware college management with modern student services.', '<section><h2>About the College</h2><p>Junior College supports admissions, scholarships, certificates, student mentoring, and transparent academic communication.</p></section><section><h2>Key Highlights</h2><ul><li>Scholarship help desk</li><li>Verified fee receipts</li><li>IQAC-ready documentation</li></ul></section>', 'Junior College Admissions, Scholarship and Student Support', 'Explore admissions, scholarships, receipts, and student support services for Junior College.', 1, 1, NOW(), NOW()),
(2, 1, 'about', 'About Us', 'About', 'About Our Junior College', 'NAAC-ready teaching, guidance, and transparent student support processes.', '<section><h2>Institution Profile</h2><p>The institute focuses on quality education, scholarship support, and digital academic administration for students and parents.</p></section><section><h2>Vision</h2><p>To provide equitable, student-focused, and quality-oriented higher secondary education.</p></section>', 'About Junior College and Academic Services', 'Learn about the institute profile, academic support, and student development services.', 1, 2, NOW(), NOW()),
(3, 2, 'home', 'Home', 'Home', 'Degree College Home', 'Career-focused undergraduate programs', 'Career-focused undergraduate programs with transparent student services.', '<section><h2>Programs</h2><p>B.A., B.Com., and BCA public information, student services, and admission guidance are managed in one place.</p></section>', 'Degree College Programs and Admission Support', 'Degree College public information page with programs, student services, and admission updates.', 1, 1, NOW(), NOW()),
(4, 1, 'admissions', 'Admissions', 'Admissions', 'Admissions and Eligibility', 'Admission support for FYJC and scholarship-oriented applicants.', '<section><h2>Admission Process</h2><ol><li>Enquiry registration</li><li>Document verification</li><li>Merit and allotment</li><li>Fee confirmation</li></ol></section>', 'Admissions and Eligibility Details', 'Admission process, eligibility, document checklist, and counselling guidance for new students.', 1, 3, NOW(), NOW()),
(5, 1, 'academics', 'Academics', 'Academics', 'Academic Programs and Student Support', 'Curriculum support, mentoring, and examination readiness.', '<section><h2>Academic Support</h2><ul><li>Bridge courses</li><li>Mentoring</li><li>Result analysis</li><li>Career guidance</li></ul></section>', 'Academic Programs and Student Support', 'Explore curriculum support, mentoring, and examination services for students.', 1, 4, NOW(), NOW()),
(6, 1, 'facilities', 'Facilities', 'Facilities', 'Campus Facilities', 'Library, ICT support, counselling, and student service windows.', '<section><h2>Facilities</h2><ul><li>Library and reading room</li><li>ICT-enabled classroom support</li><li>Scholarship help desk</li><li>Student grievance support</li></ul></section>', 'Campus Facilities and Student Services', 'College facilities including library, ICT resources, and student support services.', 1, 5, NOW(), NOW()),
(7, 1, 'iqac', 'IQAC', 'IQAC', 'IQAC and Quality Assurance', 'Quality initiatives, NAAC readiness, and documentation support.', '<section><h2>IQAC Initiatives</h2><p>Academic planning, feedback, documentation, and evidence management are coordinated through the quality cell.</p></section>', 'IQAC and NAAC Quality Initiatives', 'Public overview of quality assurance, IQAC initiatives, and NAAC-aligned work.', 1, 6, NOW(), NOW()),
(8, 1, 'contact', 'Contact', 'Contact', 'Contact and Help Desk', 'Reach the admission desk, office, and student support team.', '<section><h2>Office Contact</h2><p>Visitors may contact the office for admissions, certificates, fees, and scholarship support during working hours.</p></section>', 'Contact Office and Help Desk', 'Contact details for admission desk, office staff, and student help support.', 1, 7, NOW(), NOW());
